...
BOARD_PREBUILT_BOOTIMAGE := vendor/nxp-opensource/imx-gki/boot_8q_car.img
  else
...
ifeq ($(PRODUCT_IMX_CAR),true)
BOARD_SYSTEM_KERNEL_MODULES += $(wildcard vendor/nxp-opensource/imx-gki/system_dlkm_staging_8q_car/flatten/lib/modules/*.ko)
else
