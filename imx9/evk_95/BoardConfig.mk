...
BOARD_BOOTCONFIG += androidboot.dpu_composition=0
else
...
ifeq ($(PRODUCT_IMX_CAR),true)
  ifeq ($(PRODUCT_IMX_CAR_M7),true)
    ...
    TARGET_BOARD_DTS_CONFIG += imx95-a1:imx95-19x19-a1-evk-car-adv7535.dtb
    ...
    TARGET_BOARD_DTS_CONFIG += imx95-mipi-lvds1-a1:imx95-19x19-a1-evk-car-adv7535-it6263-lvds1.dtb
    ...
    TARGET_BOARD_DTS_CONFIG += imx95-lvds0-a1:imx95-19x19-a1-evk-car-it6263-lvds0.dtb
    ...
    TARGET_BOARD_DTS_CONFIG += imx95-verdin-a1:imx95-19x19-a1-verdin-car-lt8912.dtb
    ...
    TARGET_BOARD_DTS_CONFIG += imx95-verdin-adv7535-a1:imx95-19x19-a1-verdin-car-adv7535.dtb
    ...
    TARGET_BOARD_DTS_CONFIG += imx95-a1:imx95-19x19-a1-evk-car2-adv7535.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-mipi-lvds1:imx95-19x19-evk-car2-adv7535-it6263-lvds1.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-mipi-lvds1-a1:imx95-19x19-a1-evk-car2-adv7535-it6263-lvds1.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-lvds0:imx95-19x19-evk-car2-it6263-lvds0.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-lvds0-a1:imx95-19x19-a1-evk-car2-it6263-lvds0.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-verdin:imx95-19x19-verdin-car2-lt8912.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-verdin-a1:imx95-19x19-a1-verdin-car2-lt8912.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-verdin-adv7535:imx95-19x19-verdin-car2-adv7535.dtb
    TARGET_BOARD_DTS_CONFIG += imx95-verdin-adv7535-a1:imx95-19x19-a1-verdin-car2-adv7535.dtb
