...
PRODUCT_COPY_FILES += \
    ...
    $(CONFIG_REPO_PATH)/common/audio-json/wm8904_car_config.json:$(TARGET_COPY_OUT_VENDOR)/etc/configs/audio/wm8904_config.json \
...
PRODUCT_COPY_FILES += \
    ...
    $(IMX_DEVICE_PATH)/imx_evs_configuration_imx95-ox03c10.xml:$(TARGET_COPY_OUT_VENDOR)/etc/automotive/evs/imx_evs_aidl_configuration.xml \
...
ifeq ($(PRODUCT_IMX_CAR),true)
PRODUCT_COPY_FILES += \
    device/nxp/imx9/displayconfig/display_layout_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/displayconfig/display_layout_configuration.xml
else
PRODUCT_COPY_FILES += \
