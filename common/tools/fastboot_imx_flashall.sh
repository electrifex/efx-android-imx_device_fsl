...
options:
  ...
  -u uboot_feature  flash uboot or spl&bootloader image with "uboot_feature" in their names
                        ...
                        Below table lists the legal value supported now based on the soc_name provided:
                           ...
                           │                │  15x15 15x15-dual trusty-15x15-rbidx-blob-dual trusty-15x15-dual 15x15-evk-uuu rpmsg sof             │
  ...
  -d dtb_feature    flash dtbo, vbmeta and recovery image file with "dtb_feature" in their names
                        ...
                        Below table lists the legal value supported now based on the soc_name provided:
                           ...
                           │                │  dual-basler-revb4 os08a20-ov5640-revb4 os08a20-revb4 frdm  pciewifi                                 │
                           ├────────────────┼──────────────────────────────────────────────────────────────────────────────────────────────────────┤
...
imx95_uboot_feature=(dual trusty-dual trusty-secure-unlock-dual evk-uuu verdin trusty-verdin-dual verdin-uuu 15x15 15x15-dual trusty-15x15-dual trusty-15x15-rbidx-blob-dual 15x15-evk-uuu rpmsg sof gbl trusty-gbl-dual 15x15-gbl trusty-15x15-gbl-dual 15x15-frdm 15x15-frdm-uuu trusty-15x15-frdm-dual)
